...
// The answer is [c]: z then y ------ The reason for this is because setTimeout will delay the anonymous function by 1ms.  The JS will move down to "z" and run that first.  It will run "y" after because 'letter' will take the value of "y" once the function runs after its 1ms delay.
...
var testing = spanishColor('blanco');
...
/********** DIFFERENT VERSION I GOT HELP WITH ************/
